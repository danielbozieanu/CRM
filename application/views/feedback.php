    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="minAnswers" value="<?php echo count($all_questions); ?>">
...
<!--                            <input type="hidden" name="ansId[]" value="--><?php //echo $answer['ans_id']; ?><!--">-->
                            <label>
                                ...
                                <input type="<?php echo $question['question_type']; ?>" name="radios[]" value="<?php echo $answer['ans_id'] ?>">
                                <?php else: ?>
