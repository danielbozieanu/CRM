...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Feb 2017 la 18:26
...
--
-- Salvarea datelor din tabel `answers_project`
--

INSERT INTO `answers_project` (`id`, `answer_question`, `answer_project`, `answer_value`, `answer_selected`, `feedback_text`) VALUES
(307, 75, 23, 'DADA', 0, NULL),
(308, 75, 23, 'NUNU', 0, NULL),
(309, 76, 23, 'Nu stiu', 0, NULL),
(310, 76, 23, 'ba stiu', 0, NULL),
(311, 77, 23, 'DA', 0, NULL),
(312, 77, 23, 'NU', 0, NULL);
...
(35, 'Formular 1', 0, '2017-02-16', '0000-00-00'),
(36, 'asdfasdfasdfasdfsadf', 0, '2017-02-16', '0000-00-00');
...
INSERT INTO `projects` (`project_id`, `project_name`, `project_client`, `project_status`, `project_estimate`, `project_final_client`, `project_value`, `project_costs`, `project_created`, `project_finished`, `form_template`, `form_slug`, `form_completed`, `form_sent_date`) VALUES
(23, 'Telekom B2B', 2, 1, 2, 'Telekom2', 50000, 123000, '2017-02-14', '2017-02-16', 36, 'RP2K1jms5aILz3ld', NULL, '0000-00-00');
...
--
-- Salvarea datelor din tabel `questions_project`
--

INSERT INTO `questions_project` (`id`, `question_project`, `question_label`, `question_type`) VALUES
(75, 23, 'Intrebarea 1', 'radio'),
(76, 23, 'Multumit??', 'checkbox'),
(77, 23, 'Ceva nou', 'radio'),
(78, 23, 'feedback 1', 'textarea'),
(79, 23, 'feedback 2', 'textarea');
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, '0H09M29kllsLSD336QXRL.', 1268889823, 1487247964, 1, 'Daniel', 'Bozieanu', 'ADMIN', '0743555586'),
(2, '127.0.0.1', 'administrator2', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'daniel.bozieanu@gmail.com', 'dd2a708c95484c91548579331aba5820da123bbe', NULL, NULL, NULL, 1268889823, 1484419582, 0, 'Madalina', 'State', 'KINECTO', '0'),
